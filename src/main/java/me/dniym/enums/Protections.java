...
public enum Protections {
    ...
    BlockNonPlayersInNetherPortal(16, true, "Prevent Nether Portal Dupe", "ALL", "Exploits.PortalDupe.BlockNonPlayersInNetherPortal", "This setting prevents non player entities from travelling through a nether portal (typically horses and donkeys).  This exploit is used to duplicate the contents of a entities inventory by killing them just as they enter the portal, this setting also defeats sand / falling block dupers.", "", 0, false),
    ...
    BlockNonPlayersInEndPortal(17, true, "Prevent End Portal Dupe", "ALL", "Exploits.PortalDupe.BlockNonPlayersInEndPortal", "This setting prevents non player entities from travelling through the end portal (typically horses and donkeys).  This exploit is used to duplicate the contents of a entities inventory by killing them just as they enter the portal, this setting also defeats sand / falling block dupers.", "", 0, false),
    ...
    WatchForAutoFishMod(20, true, "Prevent Auto Fish Mods", "ALL", "Exploits.FishMod.WatchForAutoFishMod", "Detects automatic fishing mods that cast and reel in fish that mimic regular player fishing, this is not an instantaneous detection and does not detect auto me.dniym.fishing on the first attempt..", "", 0, false),
    ...
    WarnPlayerThenKickInsteadOfNotify(20, false, "Notify Instead of Kick", 20, "Exploits.FishMod.WarnPlayerThenKickInsteadOfNotify", "This setting defaults to false, and staff is notified when a player is suspected of using an auto fishing mod.  If set to true the player will be warned right before they're about to be kicked after the plugin has detected they are using an auto-me.dniym.fishing mod.", "", 0, false),
    ...
    RemoveAllRenamedItems(44, false, "Remove ALL renamed items", "ALL", "UserRequested.Obscure.Misc.RemoveAllRenamedItems", "Removes any item that has been renamed found on any user without the IllegalStack.RenameBypass permission.", "", 2, false),
    ...
    IgnoreAllShulkerPlaceChecks(55, false, "Ignore ALL Shulker Place Checks", "ALL", "UserRequested.Obscure.IgnoreAllShulkerPlaceChecks", "Forces the plugin to Ignore any shulker place event. This will disable removal of stacked items when a shulker is placed", "", 2, false),
    ;
    ...
    Protections(int id, String[] array, String dname, Object ver, String path, String desc, String cmd, int catId, boolean relevant) {
        ...
        for (String s : array) this.getTxtSet().add(s);
